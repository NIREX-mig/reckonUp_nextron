  ...
  return (
    <div className="relative mb-5 flex items-center justify-between">
      <div className="flex gap-3">
        ...
        <div>
          <h1 className="bg-gradient-to-r from-green-600 via-green-500 to-green-300 bg-[200%_auto] bg-clip-text text-[20px] font-semibold tracking-[5px] text-transparent">
            {shopName}
          </h1>
          <p className="text-[15px] tracking-[4px] text-[#333]">{address}</p>
          <p className="text-[15px] tracking-[4px] text-[#333]">{mobileNo} {whatsappNo}</p>
        </div>
      </div>
